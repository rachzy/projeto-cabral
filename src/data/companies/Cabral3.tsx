import banner from "../../assets/images/companies/cabral-3/banner.jpg";
import logo from "../../assets/images/companies/cabral-3/logo.png";

import Pic1 from "../../assets/images/companies/cabral-3/foto1.png";
import Pic2 from "../../assets/images/companies/cabral-3/foto2.png";
import Pic3 from "../../assets/images/companies/cabral-3/foto3.png";
import Pic4 from "../../assets/images/companies/cabral-3/foto4.png";
import Pic5 from "../../assets/images/companies/cabral-3/foto5.png";
import Pic6 from "../../assets/images/companies/cabral-3/foto6.png";

import horario from "../../assets/images/companies/cabral-3/horario.png";
...
const Cabral3: ICompany = {
  id: "cabral-3",
  title: "Posto Cabral 3",
  banner: banner,
  logo: logo,
  ...
  contacts: [
    {
      label:
        "Av. Maria do Prado Silva, 507, Bairro José Rodrigues, Santa Juliana/MG",
      href: "https://goo.gl/maps/CUiWErgAQCLQqfhm8",
      icon: PointerIcon,
    },
    {
      label: "(34) 3354-2270",
